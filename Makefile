...
verify:
	@forge verify-contract --chain-id 11155111 --num-of-optimizations 200 --watch --constructor-args 0x00000000000000000000000000000000000000000000d3c21bcecceda1000000 --etherscan-api-key $(ETHERSCAN_API_KEY) --compiler-version v0.8.18+commit.7dd6d404 0x089dc24123e0a27d44282a1ccc2fd815989e3300 src/RecognitionToken.sol:RecognitionToken